    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 rounded-lg bg-[#141b2b] md:flex-row md:space-x-8 md:mt-0 md:bg-transparent">
                ...
                <li>
                    <a href="{{route('home')}}#features" class="block py-2 px-3 text-gray-800 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Services</a>
                </li>
                @guest
                    @if (Route::has('login'))
                        <li class="nav-item">
                ...
                @else
                    <li>
                        <a href="{{ route('dashboard') }}" class="block py-2 px-3 text-gray-800 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Dashboard</a>
                    </li>
